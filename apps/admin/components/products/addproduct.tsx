...
import { ArrowLeft, Info, PlusCircle, X } from "react-feather";
      ...
      <div className="content max-w-6xl mx-auto">
        ...
        <form className="space-y-6">
          ...
          <div className="border rounded shadow-sm">
            ...
            >
              <h5 className="flex items-center text-lg font-medium text-gray-700">
                <Info className="text-blue-500 mr-2" />
                Product Information
              </h5>
              <span className="text-gray-500">{accordionOpen ? "-" : "+"}</span>
            </button>
            {accordionOpen && (
              <div className="p-4 border-t space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select options={store} placeholder="Choose" />
                  </div>
                  <div>
                    <label className="block mb-1 font-medium">
                      Warehouse <span className="text-red-500">*</span>
                    </label>
                    <Select options={warehouse} placeholder="Choose" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      className="w-full border rounded p-2 pr-20 focus:outline-none focus:ring focus:ring-blue-200"
                    />
                    <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700">
                      Generate
                    </button>
                  </div>
                  <div>
                    ...
                    <Select options={sellingtype} placeholder="Choose" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex flex-col">
                    ...
                    <Select options={category} placeholder="Choose" />
                  </div>
                  <div>
                    <label className="block mb-1 font-medium">
                      Sub Category <span className="text-red-500">*</span>
                    </label>
                    <Select options={subcategory} placeholder="Choose" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select options={brand} placeholder="Choose" />
                  </div>
                  <div>
                    <label className="block mb-1 font-medium">
                      Unit <span className="text-red-500">*</span>
                    </label>
                    <Select options={unit} placeholder="Choose" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select options={barcodesymbol} placeholder="Choose" />
                  </div>
                  <div className="relative">
                    <label className="block mb-1 font-medium">
