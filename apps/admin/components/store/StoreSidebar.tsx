...
const STORE_MENU = [
  { label: "Dashboard", icon: "layout-grid", link: "/dashboard" },
  { label: "Products", icon: "box", link: "/products" },
  ...
  return (
    <div
      className={`sidebar ${toggle ? "" : "active"} ${
        expandMenus ? "expand-menu" : ""
      }`}
      onMouseOver={() => setExpandMenus(true)}
      onMouseLeave={() => setExpandMenus(false)}
    >
      <div className="sidebar-logo p-3 flex items-center justify-between">
        <Link href="/dashboard" className="logo">
          <img src="/assets/img/logo.svg" alt="Logo" />
