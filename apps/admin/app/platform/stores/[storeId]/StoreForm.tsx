// apps/admin/app/(platform)/platform/stores/StoreForm.tsx
          ...
          {/* <div>
            ...
            <div className="relative flex items-center">
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 focus:ring-2 focus:ring-blue-500 outline-none transition font-mono text-sm"
                required
              />
            </div>
            <p className="mt-1 text-xs text-gray-400">
              URL: <span className="text-blue-500">{slug || "your-store"}.domain.com</span>
            </p>
          </div> */}
