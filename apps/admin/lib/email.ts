...
const SMTP_PROFILES = {
  default: {
    ...
    fromAddress:
      process.env.SMTP_DEFAULT_FROM || '"Acme Platform" <no-reply@acme.com>',
  },
  onboarding: {
    ...
    fromAddress:
      ...
      '"Acme Onboarding" <partners@acme.com>',
  },
  billing: {
    ...
    fromAddress:
      process.env.SMTP_BILLING_FROM || '"Acme Billing" <finance@acme.com>',
  },
  support: {
    ...
    fromAddress:
      process.env.SMTP_SUPPORT_FROM || '"Acme Support" <support@acme.com>',
  },
};
